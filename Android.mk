...
include $(CLEAR_VARS)
LOCAL_MODULE := beatsaber-hook_3_6_0
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -DVERSION='"3.6.0"' -isystem 'extern/libil2cpp/il2cpp/libil2cpp' -D'UNITY_2019' -Wall -Wextra -Werror -Wno-unused-function -DID='"beatsaber-hook"' -I'./shared' -isystem 'extern'
